...
tensorboardcall=callbacks.TensorBoard(log_dir='/home/zenin/logs100v2',write_graph=True, write_images=True,
                                      embeddings_freq=50, embeddings_layer_names=None, embeddings_metadata=None)
checkpointer = callbacks.ModelCheckpoint(filepath="/home/zenin/weights100v2.{epoch:02d}-{val_loss:.2f}.hdf5",monitor='val_loss', verbose=1, save_best_only=True, mode='auto', period=10)
# train the model
start = time.time()
# Train the model
